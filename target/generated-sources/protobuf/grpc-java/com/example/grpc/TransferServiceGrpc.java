...
@javax.annotation.Generated(
    ...
    comments = "Source: TransferService.proto")
public final class TransferServiceGrpc {

  private TransferServiceGrpc() {}

  public static final String SERVICE_NAME = "com.example.grpc.TransferService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.TransferServiceOuterClass.TransferRequest,
      com.example.grpc.TransferServiceOuterClass.TransferResponse> METHOD_TRANSFER =
      io.grpc.MethodDescriptor.<com.example.grpc.TransferServiceOuterClass.TransferRequest, com.example.grpc.TransferServiceOuterClass.TransferResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.grpc.TransferService", "transfer"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.TransferServiceOuterClass.TransferRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.TransferServiceOuterClass.TransferResponse.getDefaultInstance()))
  ...
  public static abstract class TransferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void transfer(com.example.grpc.TransferServiceOuterClass.TransferRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.TransferServiceOuterClass.TransferResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.TransferServiceOuterClass.TransferRequest,
                com.example.grpc.TransferServiceOuterClass.TransferResponse>(
  ...
  public static final class TransferServiceBlockingStub extends io.grpc.stub.AbstractStub<TransferServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.TransferServiceOuterClass.TransferResponse transfer(com.example.grpc.TransferServiceOuterClass.TransferRequest request) {
  ...
  public static final class TransferServiceFutureStub extends io.grpc.stub.AbstractStub<TransferServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.TransferServiceOuterClass.TransferResponse> transfer(
        com.example.grpc.TransferServiceOuterClass.TransferRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TRANSFER:
          serviceImpl.transfer((com.example.grpc.TransferServiceOuterClass.TransferRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.TransferServiceOuterClass.TransferResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.TransferServiceOuterClass.getDescriptor();
    }
